...
koodi::koodi()
{
    ...
    const int num_yrityksia = 1000000000;
        ...
        double probability = static_cast<double>(num_kymmenen_perkkaiset_klaavat) / num_yrityksia;
